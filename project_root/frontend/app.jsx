...
// Create a reusable root and expose it so other scripts can re-render (dashboard swap)
window.__APP_ROOT__ = ReactDOM.createRoot(document.getElementById('root'));
