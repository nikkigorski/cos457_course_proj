...
Goal: Creating a database where users can login, submit notes, see what resources their professors have verified, and rate other's notes for their classes
