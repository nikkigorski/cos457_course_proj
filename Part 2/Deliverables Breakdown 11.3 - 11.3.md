...
2. MySQL Database Schema Scripts (.sql)		
Member	Contribution	
...
4. Data Scraping Scripts and Documentation		
...
5. Sample Data and Data Cleaning Documentation		
Team Member	Primary Task (Owner: Nikki)	
...
7. Comprehensive README file (.md)		
